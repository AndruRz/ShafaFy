          ...
          <div className="topics-section">
            ...
            <div className="topics-grid">
              ...
              <div className="topic-card">
                ...
                <h4>Árboles</h4>
                <p>Árboles binarios para organización jerárquica de géneros y artistas.</p>
              </div>
...
function App() {
  return (
    <Router>
      <Routes>
        {/* Ruta principal - Landing Page (siempre accesible) */}
        <Route path="/" element={<LandingPage />} />
        
        {/* Ruta de autenticación (pública - si ya está autenticado, redirige al reproductor) */}
        <Route 
          path="/auth" 
          element={
            <PublicRoute>
        ...
        {/* Ruta del reproductor (protegida - requiere autenticación) */}
        <Route 
          path="/reproductor" 
          element={
            <ProtectedRoute>
